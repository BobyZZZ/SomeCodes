...
import com.bb.module_bookstore.adapter.SortNovelAdapter;
import com.bb.module_bookstore.mvp.presenter.SortFragmentPresenter;
import com.bb.module_common.base.BaseMvpListFragment;
...
public class SortFragment extends BaseMvpListFragment<SortFragmentPresenter, SortNovelAdapter> implements SortFragmentContract.IView,
    ...
    protected SortNovelAdapter createAdapter() {
        return new SortNovelAdapter(R.layout.item_sort_novel, new ArrayList<NovelInfo>());
    }
    ...
    public void addNovels(List<NovelInfo> novels, boolean hasMore, boolean cleanOldData) {
        if (cleanOldData) {
            mAdapter.setNewInstance(new ArrayList<NovelInfo>());
        }
